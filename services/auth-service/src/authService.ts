...
import type { AuthTokens, JWTPayload } from "../../../shared/types/index.js";
...
export class AuthService {
  ...
  async refreshToken(refreshToken: string): Promise<AuthTokens> {
    try {
      ...
      throw createServiceError("Invalid refresh token", 401, String(error));
    }
  }
  ...
  async validateToken(token: string): Promise<JWTPayload> {
    try {
      ...
      throw createServiceError("Token validation failed", 500, String(error));
    }
  }
